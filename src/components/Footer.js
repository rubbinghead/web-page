            ...
            <footer>
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
                    ...
                    <div className="col-span-12 lg:col-span-4">
                        <div className="box-border border-b-4 border-blue-900 p-8 bg-gray-200 text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                            <h3 className="font-bold text-3xl mb-4">RubbingHead AI</h3>
                    ...
                    <div className="col-span-6 md:col-span-6 lg:col-span-4 mx-auto">
                        ...
                        <li className="mb-2">
                            <Link to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">AI Generation</Link>
                        </li>
                        <li className="mb-2">
                            <Link to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Searching Systems</Link>
                        </li>
                        <li className="mb-2">
                            <Link to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Question Answering</Link>
                        </li>
                        </ul>
                    </div>
                ...
                <div className="w-full md:w-4/12 px-4 mx-auto text-center py-2">
                    ...
                    Copyright &copy; {new Date().getFullYear()}{"  "}
                        RubbingHead AI. All rights reserved.
                    </div>
                </div>
                </div>
